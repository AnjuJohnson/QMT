...
public class GetChapterNotZeroActiveTask extends AsyncTask<Void, Void, List<ChapterList>> {

     ChapterListDao ChapterListDao;
    private Context ctx;
    public GetChapterNotZeroActiveTask(Context context) {
        this.ctx = context;
    ...
    protected List<ChapterList> doInBackground(Void... voids) {
        try {
            return ChapterListDao.getChapterExceptZeroList();
