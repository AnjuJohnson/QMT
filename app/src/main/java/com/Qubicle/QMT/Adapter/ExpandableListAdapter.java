...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private List<ChapterList> items;
    private String malayalamFont, arabicfont;

    public void setData(List<ChapterList> items) {
        this.items = items;
    }
    ...
    public ExpandableListAdapter(SuraListener suraListener, Context context, List<ChapterList> items, String malayalamFont, String arabicFont) {
    ...
    public void optionUpdate(List<ChapterList> list) {
        this.items = list;
        notifyDataSetChanged();
    }
    ...
    public View getChildView(final int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        viewHolderChild.txtListChildayat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mSuraListener.verse_detail(items.get(groupPosition).getSurah_no(), childItem.getAyat_id(), childItem.getAyat_no());
            }
        });
        return convertView;
    }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            ...
            LayoutInflater infalInflater = (LayoutInflater) this._context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.dummygrupitem, null);
        ...
        viewHolder.chapterqa = (ImageView) convertView.findViewById(R.id.imageView8);
        ...
        viewHolder.optionslayout = (RelativeLayout) convertView
                .findViewById(R.id.optionslayout);
        viewHolder.chapterlayout = (RelativeLayout) convertView
                .findViewById(R.id.chapterlayout);
        viewHolder.lblListHeader.setTypeface(null, Typeface.BOLD);
        viewHolder.versusimage = (ImageView) convertView.findViewById(R.id.versusimage);
        viewHolder.explanationimage = (ImageView) convertView.findViewById(R.id.explanationimage);
        viewHolder.indeximage = (ImageView) convertView.findViewById(R.id.indeximage);
...
////////
        ...
        if (groupItem.getSurah_no().equalsIgnoreCase("0")) {
            viewHolder.lblListHeader.setText(groupItem.getChapter_name().replaceFirst("^ *", ""));

        } else {
            viewHolder.lblListHeader.setText(groupItem.getSurah_no() + ". " + groupItem.getChapter_name().replaceFirst("^ *", ""));
...
/////////////
       /* viewHolder.lblListHeader.setOnClickListener(new View.OnClickListener() {
        ...
        viewHolder.chapterqa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mSuraListener.chapterqa(groupItem.getSurah_no());
            }
        });
///new
        // wordmeaning on and off
        viewHolder.chapterlayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                mSuraListener.optionOn(groupItem.getSurah_no(), String.valueOf(groupPosition));
...
// verse on and off
        viewHolder.versusimage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                mSuraListener.verseopen(groupItem.getSurah_no(), String.valueOf(groupPosition));


            }
        });

        viewHolder.explanationimage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        viewHolder.indeximage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                mSuraListener.indexopen(groupItem.getChapter_name(), groupItem.getSurah_no());
    ...
    public class ViewHolder {
        ...
        ImageView img, chapterqa, versusimage, explanationimage, indeximage;
        RelativeLayout optionslayout, chapterlayout;
    }
