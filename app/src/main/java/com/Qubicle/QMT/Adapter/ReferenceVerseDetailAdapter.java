 ...
 */
public class ReferenceVerseDetailAdapter extends RecyclerView.Adapter<ReferenceVerseDetailAdapter.ViewHolder> {
    ...
    public ReferenceVerseDetailAdapter(BookmarkListner bookmarkListner, AudioListner audioListner, VerseDetailListener verseDetailListener, List<VerseDetail> verseDetailList, Context context, String mVerseRadioButton,
    ...
    @Override
    public ReferenceVerseDetailAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.verselist_item, viewGroup, false);
        return new ReferenceVerseDetailAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final ReferenceVerseDetailAdapter.ViewHolder viewHolder, final int i) {
