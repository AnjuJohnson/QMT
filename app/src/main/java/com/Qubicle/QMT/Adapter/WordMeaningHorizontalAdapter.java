 ...
 */
public class WordMeaningHorizontalAdapter extends RecyclerView.Adapter<WordMeaningHorizontalAdapter.ViewHolder> {
    private List<WordMeaningList> verseDetailList;
String sWordMeaningRadioButton,sMalayalamFont,sArabicFont;
    public WordMeaningHorizontalAdapter(List<WordMeaningList> verseDetailList,String sWordMeaningRadioButton,String sMalayalamFont,
                                        String sArabicFont) {
    ...
    @Override
    public WordMeaningHorizontalAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(WordMeaningHorizontalAdapter.ViewHolder viewHolder, int i) {
        if(sWordMeaningRadioButton.equalsIgnoreCase("wordmeaningOn")){
            viewHolder.mMeaningMalayalamTextView.setText(verseDetailList.get(i).getMeaning_mala());
